    ...
    <form action="index.php?act=dangky" method="post">
        ...
        <?php endif; ?>
                        ...
                        <div class="mb-3">
                          ...
                          <input type="password" class="form-control" id="pwd" placeholder="Nhập mật khẩu" name="">
                        </div>
                        <div class="mb-3">
                          <label for="pwd" class="form-label">Nhập lại mật khẩu:</label>
                          <input type="password" class="form-control" id="pwd" placeholder="Xác nhận mật khẩu" name="">
                        </div>
