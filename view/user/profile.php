...
<div class="main-content">
    <div class="profile-info">
        ...
        <hr>
        <div class="mb-3 mt-3">
            <p><strong>Họ và tên:</strong> <span id="hoten"><?php echo $hoten; ?></span></p>
        </div>
        <div class="mb-3">
            <p><strong>Email:</strong> <span id="email"><?php echo $email; ?></span></p>
        </div>
        <div class="mb-3">
            <p><strong>Số Điện Thoại:</strong> <span id="sodienthoai"><?php echo $sodienthoai; ?></span></p>
        </div>
        <div class="mb-3">
            <p><strong>Địa Chỉ:</strong> <span id="diachi"><?php echo $diachi; ?></span></p>
